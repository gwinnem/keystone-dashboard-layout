  ...
  return (
    <>
      <div className="demo-controls">
        <ExampleToggle checked={isBounded} label="isBounded" onChange={setIsBounded} />
      </div>

      <GridLayout isBounded={isBounded} layout={layout} onLayoutChange={setLayout} rowHeight={60} showGridLines>
        {layout.map((item) => (
