...
@Component({
  ...
  template: `
    <div class="demo-controls">
      <example-toggle [checked]="showCloseButton" (checkedChange)="showCloseButton = $event" label="showCloseButton"></example-toggle>
    </div>

    <kdl-grid-layout [colNum]="12" [layout]="layout" (layoutChange)="layout = $event" [rowHeight]="60" [showCloseButton]="showCloseButton" [showGridLines]="true">
