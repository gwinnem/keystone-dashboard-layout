...
@Component({
  selector: 'app-responsive-breakpoints-demo',
  standalone: true,
  ...
  template: `
    ...
    <p class="demo-description">
      ...
      — the library's own defaults are much larger, sized for a real page rather than a
      docs-example panel.
    </p>
...
export class ResponsiveBreakpointsDemoComponent {
  breakpoints = BREAKPOINTS;
  cols = COLS;
  lastBreakpoint = '—';
